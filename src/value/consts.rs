use crate::{
    consts::{
        ...
        MASS_INDEX, MASS_MAP, SUBSTANCE_INDEX, SUBSTANCE_MAP, TEMPERATURE_INDEX, TEMPERATURE_MAP,
        TIME_INDEX, TIME_MAP, VAL_ABS_ZERO, VAL_ATOMIC_MASS, VAL_AVOGADROS, VAL_BOLTZMANN,
        VAL_COULOMBS, VAL_EARTH_GRAV, VAL_ELECTRON_CHARGE, VAL_FARADAY, VAL_LIGHT_SPEED,
        VAL_MOLAR_GAS, VAL_NEWTONIAN_GRAVITATION, VAL_PLANKS, VAL_RYDBERG,
        VAL_VACUUM_ELECTRIC_PERMITTIVITY,
    },
    units::{
