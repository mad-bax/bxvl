...
#[cfg(test)]
mod time_testing {
    use crate::units::{BaseUnit, Metric, time::UnitTime};
    ...
    fn unit_angle_scale() {
        ...
        for i in [
            ...
            (UnitTime::Second(Metric::Exa), 1.0e18),
            (UnitTime::Second(Metric::Femto), 1.0e-15),
            (UnitTime::Second(Metric::Giga), 1.0e9),
            (UnitTime::Second(Metric::Hecto), 100.0),
            (UnitTime::Second(Metric::Kilo), 1.0e3),
            (UnitTime::Second(Metric::Mega), 1.0e6),
            (UnitTime::Second(Metric::Micro), 1.0e-6),
            (UnitTime::Second(Metric::Milli), 0.001),
            (UnitTime::Second(Metric::Nano), 1.0e-9),
            (UnitTime::Second(Metric::None), 1.0),
            (UnitTime::Second(Metric::Peta), 1.0e15),
            (UnitTime::Second(Metric::Pico), 1.0e-12),
            (UnitTime::Second(Metric::Tera), 1.0e12),
            (UnitTime::Second(Metric::Yocto), 1.0e-24),
            (UnitTime::Second(Metric::Yotta), 1.0e24),
            (UnitTime::Second(Metric::Zepto), 1.0e-21),
            (UnitTime::Second(Metric::Zetta), 1.0e21),
            (UnitTime::Hour, 1.0),
            (UnitTime::Minute, 1.0),
            (UnitTime::Day, 1.0),
        ] {
