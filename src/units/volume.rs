...
mod volume_testing {
    ...
    fn unit_angle_scale() {
        ...
        for i in [
            (UnitVolume::Liter(Metric::Atto), 0.000000000000000001),
            (UnitVolume::Liter(Metric::Centi), 0.01),
            (UnitVolume::Liter(Metric::Deca), 10.0),
            (UnitVolume::Liter(Metric::Deci), 0.1),
            (UnitVolume::Liter(Metric::Exa), 1000000000000000000.0),
            (UnitVolume::Liter(Metric::Femto), 0.000000000000001),
            (UnitVolume::Liter(Metric::Giga), 1000000000.0),
            (UnitVolume::Liter(Metric::Hecto), 100.0),
            (UnitVolume::Liter(Metric::Kilo), 1000.0),
            (UnitVolume::Liter(Metric::Mega), 1000000.0),
            (UnitVolume::Liter(Metric::Micro), 0.000001),
            (UnitVolume::Liter(Metric::Milli), 0.001),
            (UnitVolume::Liter(Metric::Nano), 0.000000001),
            ...
            (UnitVolume::Liter(Metric::Zepto), 0.000000000000000000001),
            (UnitVolume::Liter(Metric::Zetta), 1000000000000000000000.0),
        ] {
