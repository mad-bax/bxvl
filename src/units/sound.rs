...
mod sound_testing {
    ...
    fn unit_angle_scale() {
        ...
        for i in [
            ...
            (UnitSound::Bel(Metric::Exa), 1.0e18),
            (UnitSound::Bel(Metric::Femto), 1.0e-15),
            (UnitSound::Bel(Metric::Giga), 1.0e9),
            (UnitSound::Bel(Metric::Hecto), 100.0),
            (UnitSound::Bel(Metric::Kilo), 1.0e3),
            (UnitSound::Bel(Metric::Mega), 1.0e6),
            (UnitSound::Bel(Metric::Micro), 1.0e-6),
            (UnitSound::Bel(Metric::Milli), 0.001),
            (UnitSound::Bel(Metric::Nano), 1.0e-9),
            (UnitSound::Bel(Metric::None), 1.0),
            (UnitSound::Bel(Metric::Peta), 1.0e15),
            (UnitSound::Bel(Metric::Pico), 1.0e-12),
            (UnitSound::Bel(Metric::Tera), 1.0e12),
            (UnitSound::Bel(Metric::Yocto), 1.0e-24),
            (UnitSound::Bel(Metric::Yotta), 1.0e24),
            (UnitSound::Bel(Metric::Zepto), 1.0e-21),
            (UnitSound::Bel(Metric::Zetta), 1.0e21),
        ] {
