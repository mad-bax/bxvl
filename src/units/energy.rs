...
mod energy_testing {
    ...
    fn unit_angle_scale() {
        ...
        for i in [
            (UnitEnergy::ElectronVolt(Metric::Atto), 0.000000000000000001),
            (UnitEnergy::ElectronVolt(Metric::Centi), 0.01),
            (UnitEnergy::ElectronVolt(Metric::Deca), 10.0),
            (UnitEnergy::ElectronVolt(Metric::Deci), 0.1),
            (UnitEnergy::ElectronVolt(Metric::Exa), 1000000000000000000.0),
            (UnitEnergy::ElectronVolt(Metric::Femto), 0.000000000000001),
            (UnitEnergy::ElectronVolt(Metric::Giga), 1000000000.0),
            (UnitEnergy::ElectronVolt(Metric::Hecto), 100.0),
            (UnitEnergy::ElectronVolt(Metric::Kilo), 1000.0),
            (UnitEnergy::ElectronVolt(Metric::Mega), 1000000.0),
            (UnitEnergy::ElectronVolt(Metric::Micro), 0.000001),
            (UnitEnergy::ElectronVolt(Metric::Milli), 0.001),
            (UnitEnergy::ElectronVolt(Metric::Nano), 0.000000001),
            (UnitEnergy::ElectronVolt(Metric::None), 1.0),
            (UnitEnergy::ElectronVolt(Metric::Peta), 1000000000000000.0),
            (UnitEnergy::ElectronVolt(Metric::Pico), 0.000000000001),
            (UnitEnergy::ElectronVolt(Metric::Tera), 1000000000000.0),
            (
                UnitEnergy::ElectronVolt(Metric::Yocto),
            ...
            (UnitEnergy::GramCalorie(Metric::Exa), 1000000000000000000.0),
            (UnitEnergy::GramCalorie(Metric::Femto), 0.000000000000001),
            (UnitEnergy::GramCalorie(Metric::Giga), 1000000000.0),
            (UnitEnergy::GramCalorie(Metric::Hecto), 100.0),
            (UnitEnergy::GramCalorie(Metric::Kilo), 1000.0),
            (UnitEnergy::GramCalorie(Metric::Mega), 1000000.0),
            (UnitEnergy::GramCalorie(Metric::Micro), 0.000001),
            (UnitEnergy::GramCalorie(Metric::Milli), 0.001),
            (UnitEnergy::GramCalorie(Metric::Nano), 0.000000001),
            (UnitEnergy::GramCalorie(Metric::None), 1.0),
            (UnitEnergy::GramCalorie(Metric::Peta), 1000000000000000.0),
            (UnitEnergy::GramCalorie(Metric::Pico), 0.000000000001),
            (UnitEnergy::GramCalorie(Metric::Tera), 1000000000000.0),
            (
                UnitEnergy::GramCalorie(Metric::Yocto),
                0.000000000000000000000001,
            ),
            (
            ...
            (UnitEnergy::Joule(Metric::Exa), 1000000000000000000.0),
            (UnitEnergy::Joule(Metric::Femto), 0.000000000000001),
            (UnitEnergy::Joule(Metric::Giga), 1000000000.0),
            (UnitEnergy::Joule(Metric::Hecto), 100.0),
            (UnitEnergy::Joule(Metric::Kilo), 1000.0),
            (UnitEnergy::Joule(Metric::Mega), 1000000.0),
            (UnitEnergy::Joule(Metric::Micro), 0.000001),
            (UnitEnergy::Joule(Metric::Milli), 0.001),
            (UnitEnergy::Joule(Metric::Nano), 0.000000001),
