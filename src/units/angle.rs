    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            match self {
                ...
                Self::Degree => "°".into(),
                Self::Moa => "moa".into(),
                Self::ArcSec(Metric::None) => "asec".into(),
                Self::ArcSec(m) => format!("{}as", m.as_str()),
            }
        )
    }
}
...
impl BaseUnit for UnitAngle {
    ...
    fn base(&self) -> f64 {
        match self {
            ...
            Self::ArcSec(_) => consts::ANGLE_ASEC_TO_RAD,
        }
    }
...
mod angle_testing {
    ...
    fn unit_angle_to_string() {
        ...
        for i in [
            (UnitAngle::ArcSec(Metric::Ronna), "Ras"),
            (UnitAngle::ArcSec(Metric::Ronto), "ras"),
            (UnitAngle::ArcSec(Metric::Quecto), "qas"),
            (UnitAngle::ArcSec(Metric::Quetta), "Qas"),
            (UnitAngle::ArcSec(Metric::Atto), "aas"),
            (UnitAngle::ArcSec(Metric::Centi), "cas"),
            (UnitAngle::ArcSec(Metric::Deca), "daas"),
            (UnitAngle::ArcSec(Metric::Deci), "das"),
            (UnitAngle::ArcSec(Metric::Exa), "Eas"),
            (UnitAngle::ArcSec(Metric::Femto), "fas"),
            (UnitAngle::ArcSec(Metric::Giga), "Gas"),
            (UnitAngle::ArcSec(Metric::Hecto), "has"),
            (UnitAngle::ArcSec(Metric::Kilo), "kas"),
            (UnitAngle::ArcSec(Metric::Mega), "Mas"),
            (UnitAngle::ArcSec(Metric::Micro), "μas"),
            (UnitAngle::ArcSec(Metric::Milli), "mas"),
            (UnitAngle::ArcSec(Metric::Nano), "nas"),
            (UnitAngle::ArcSec(Metric::None), "asec"),
            (UnitAngle::ArcSec(Metric::Peta), "Pas"),
            (UnitAngle::ArcSec(Metric::Pico), "pas"),
            (UnitAngle::ArcSec(Metric::Tera), "Tas"),
            (UnitAngle::ArcSec(Metric::Yocto), "yas"),
            (UnitAngle::ArcSec(Metric::Yotta), "Yas"),
            (UnitAngle::ArcSec(Metric::Zepto), "zas"),
            (UnitAngle::ArcSec(Metric::Zetta), "Zas"),
        ] {
            assert_eq!(&i.0.to_string(), i.1);
            let t: String = i.0.into();
            assert_eq!(t, i.1.to_string());
    ...
    fn unit_angle_scale() {
        ...
        for i in [
            (UnitAngle::ArcSec(Metric::Ronna), Metric::Ronna),
            (UnitAngle::ArcSec(Metric::Ronto), Metric::Ronto),
            (UnitAngle::ArcSec(Metric::Quecto), Metric::Quecto),
            (UnitAngle::ArcSec(Metric::Quetta), Metric::Quetta),
            (UnitAngle::ArcSec(Metric::Atto), Metric::Atto),
            (UnitAngle::ArcSec(Metric::Centi), Metric::Centi),
            (UnitAngle::ArcSec(Metric::Deca), Metric::Deca),
            (UnitAngle::ArcSec(Metric::Deci), Metric::Deci),
            (UnitAngle::ArcSec(Metric::Exa), Metric::Exa),
            (UnitAngle::ArcSec(Metric::Femto), Metric::Femto),
            (UnitAngle::ArcSec(Metric::Giga), Metric::Giga),
            (UnitAngle::ArcSec(Metric::Hecto), Metric::Hecto),
            (UnitAngle::ArcSec(Metric::Kilo), Metric::Kilo),
            (UnitAngle::ArcSec(Metric::Mega), Metric::Mega),
            (UnitAngle::ArcSec(Metric::Micro), Metric::Micro),
            (UnitAngle::ArcSec(Metric::Milli), Metric::Milli),
            (UnitAngle::ArcSec(Metric::Nano), Metric::Nano),
            (UnitAngle::ArcSec(Metric::None), Metric::None),
            (UnitAngle::ArcSec(Metric::Peta), Metric::Peta),
            (UnitAngle::ArcSec(Metric::Pico), Metric::Pico),
            (UnitAngle::ArcSec(Metric::Tera), Metric::Tera),
            (UnitAngle::ArcSec(Metric::Yocto), Metric::Yocto),
            (UnitAngle::ArcSec(Metric::Yotta), Metric::Yotta),
            (UnitAngle::ArcSec(Metric::Zepto), Metric::Zepto),
            (UnitAngle::ArcSec(Metric::Zetta), Metric::Zetta),
        ] {
            assert_eq!(i.0.get_metric(), i.1);
        }

        for i in [
            (UnitAngle::ArcSec(Metric::Ronna), 1.0e27),
            (UnitAngle::ArcSec(Metric::Ronto), 1.0e-27),
            (UnitAngle::ArcSec(Metric::Quecto), 1.0e-30),
            (UnitAngle::ArcSec(Metric::Quetta), 1.0e30),
            (UnitAngle::ArcSec(Metric::Atto), 1.0e-18),
            (UnitAngle::ArcSec(Metric::Centi), 0.01),
            (UnitAngle::ArcSec(Metric::Deca), 10.0),
            (UnitAngle::ArcSec(Metric::Deci), 0.1),
            (UnitAngle::ArcSec(Metric::Exa), 1.0e18),
            (UnitAngle::ArcSec(Metric::Femto), 1.0e-15),
            (UnitAngle::ArcSec(Metric::Giga), 1.0e9),
            (UnitAngle::ArcSec(Metric::Hecto), 100.0),
            (UnitAngle::ArcSec(Metric::Kilo), 1.0e3),
            (UnitAngle::ArcSec(Metric::Mega), 1.0e6),
            (UnitAngle::ArcSec(Metric::Micro), 1.0e-6),
            (UnitAngle::ArcSec(Metric::Milli), 0.001),
            (UnitAngle::ArcSec(Metric::Nano), 1.0e-9),
            (UnitAngle::ArcSec(Metric::None), 1.0),
            (UnitAngle::ArcSec(Metric::Peta), 1.0e15),
            (UnitAngle::ArcSec(Metric::Pico), 1.0e-12),
            (UnitAngle::ArcSec(Metric::Tera), 1.0e12),
            (UnitAngle::ArcSec(Metric::Yocto), 1.0e-24),
            (UnitAngle::ArcSec(Metric::Yotta), 1.0e24),
            (UnitAngle::ArcSec(Metric::Zepto), 1.0e-21),
            (UnitAngle::ArcSec(Metric::Zetta), 1.0e21),
        ] {
            assert_eq!(i.0.scale(), i.1);
        }
    }
